...
func init() {
	...
	UpdateCostAzureUCConfigsCmd.Flags().StringP("payload", "p", "", "JSON payload of the request")
	UpdateCostAzureUCConfigsCmd.Flags().StringP("payload-file", "f", "", "Path to the JSON payload file")
