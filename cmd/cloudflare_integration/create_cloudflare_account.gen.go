...
func init() {
	...
	CreateCloudflareAccountCmd.Flags().StringP("payload", "p", "", "JSON payload of the request")
	CreateCloudflareAccountCmd.Flags().StringP("payload-file", "f", "", "Path to the JSON payload file")
