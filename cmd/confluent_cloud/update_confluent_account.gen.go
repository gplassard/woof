...
var UpdateConfluentAccountCmd = &cobra.Command{
	...
	Long: `Update Confluent account
Documentation: https://docs.datadoghq.com/api/latest/confluent-cloud/#update-confluent-account`,
...
func init() {
	...
	UpdateConfluentAccountCmd.Flags().StringP("payload", "p", "", "JSON payload of the request")
	UpdateConfluentAccountCmd.Flags().StringP("payload-file", "f", "", "Path to the JSON payload file")
