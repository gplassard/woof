...
var CreateDORADeploymentCmd = &cobra.Command{
	Use: "create-dora-deployment",

	Short: "Send a deployment event",
	Long: `Send a deployment event
Documentation: https://docs.datadoghq.com/api/latest/dora-metrics/#create-dora-deployment`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		cmdutil.HandleError(err, "failed to create-dora-deployment")
