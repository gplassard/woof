...
var CreateDORAIncidentCmd = &cobra.Command{
	Use: "create-dora-incident",

	Short: "Send an incident event (legacy)",
	Long: `Send an incident event (legacy)
Documentation: https://docs.datadoghq.com/api/latest/dora-metrics/#create-dora-incident`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		cmdutil.HandleError(err, "failed to create-dora-incident")
