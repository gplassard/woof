...
var DeleteDORADeploymentCmd = &cobra.Command{
	Use: "delete-dora-deployment [deployment_id]",

	Short: "Delete a deployment event",
	Long: `Delete a deployment event
Documentation: https://docs.datadoghq.com/api/latest/dora-metrics/#delete-dora-deployment`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		cmdutil.HandleError(err, "failed to delete-dora-deployment")
