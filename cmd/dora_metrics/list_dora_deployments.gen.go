...
var ListDORADeploymentsCmd = &cobra.Command{
	Use: "list-dora-deployments",

	Short: "Get a list of deployment events",
	Long: `Get a list of deployment events
Documentation: https://docs.datadoghq.com/api/latest/dora-metrics/#list-dora-deployments`,

	Run: func(cmd *cobra.Command, args []string) {
		apiKey, appKey, site := config.GetConfig()
		var res datadogV2.DORADeploymentsListResponse
		var err error
		...
		cmdutil.HandleError(err, "failed to list-dora-deployments")
