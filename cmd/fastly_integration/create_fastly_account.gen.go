...
var CreateFastlyAccountCmd = &cobra.Command{
	...
	Long: `Add Fastly account
Documentation: https://docs.datadoghq.com/api/latest/fastly-integration/#create-fastly-account`,
...
func init() {
	...
	CreateFastlyAccountCmd.Flags().StringP("payload", "p", "", "JSON payload of the request")
	CreateFastlyAccountCmd.Flags().StringP("payload-file", "f", "", "Path to the JSON payload file")
