...
func init() {
	...
	CreateIncidentNotificationRuleCmd.Flags().StringP("payload", "p", "", "JSON payload of the request")
	CreateIncidentNotificationRuleCmd.Flags().StringP("payload-file", "f", "", "Path to the JSON payload file")
