...
func init() {
	...
	CreateOpsgenieServiceCmd.Flags().StringP("payload", "p", "", "JSON payload of the request")
	CreateOpsgenieServiceCmd.Flags().StringP("payload-file", "f", "", "Path to the JSON payload file")
