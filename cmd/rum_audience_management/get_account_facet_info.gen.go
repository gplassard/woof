...
var GetAccountFacetInfoCmd = &cobra.Command{
	...
	Long: `Get account facet info
Documentation: https://docs.datadoghq.com/api/latest/rum-audience-management/#get-account-facet-info`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		fmt.Println(cmdutil.FormatJSON(res, "account_facet_info"))
	},
}

func init() {

	GetAccountFacetInfoCmd.Flags().StringP("payload", "p", "", "JSON payload of the request")
	GetAccountFacetInfoCmd.Flags().StringP("payload-file", "f", "", "Path to the JSON payload file")
