...
func init() {
	...
	CreateSpansMetricCmd.Flags().StringP("payload", "p", "", "JSON payload of the request")
	CreateSpansMetricCmd.Flags().StringP("payload-file", "f", "", "Path to the JSON payload file")
